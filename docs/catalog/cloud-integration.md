...
| ページ | 使う場面 |
|---|---|
| [SORACOM Napter・AWS IoT Core・SORACOM Beamで学ぶMQTTハンズオン](../labs/aws-iot-soracom-mqtt-handson) | Raspberry PiからAWS IoT Coreへ直接接続したあと、証明書をSORACOM側へ移してBeam経由へ切り替える約3時間のハンズオンを実施したい |
